...
var finalString1 = "<p id='Result1'>Case Study Result for "+selectedMethod+" method: <br>";
    ...
    $("#exportDatabase_"+el_number).click(function(){exportTableToCSV(results[objIndex].indicator, results[objIndex].indicator + '_Process1.csv',
        el_number, 1)});
    return;
        }
    ...
    $("#exportDatabase_"+el_number).click(function(){exportTableToCSVEconomic(results[objIndex].indicator, results[objIndex].indicator + '_Process1.csv',
        el_number, 1)});
    return;
        }
    ...
    $("#exportDatabase_"+el_number).click(function(){exportTableToCSVEnvironmental(results[objIndex].indicator, results[objIndex].indicator + '_Process1.csv',
        el_number, 1, type)});
    return;
        }
